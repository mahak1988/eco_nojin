// Re-exports from @eco/api-client for bazaar-related types.
// Will be replaced by generated types in Phase 3.
// Inline type stubs for scaffolding (Phase 3 will replace with generated types).
