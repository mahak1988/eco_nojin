...
_SPECS: list[dict[str, Any]] = [
        ...
        "params": [
            {
                ...
                "kind": "select",
                "default": "analytical",
                "options": ["analytical", "modflow_link"],
            },
            {
                "name": "transmissivity_m2day",
    ...
    },
    {
        ...
        "params": [
            ...
            {
                "name": "hydraulic_conductivity_m_s",
            ...
            {
                "name": "aquifer_thickness_m",
                "label": "Aquifer thickness",
                "unit": "m",
                "kind": "float",
                "default": 40.0,
            },
            {
                ...
                "kind": "select",
                "default": "UNCONFINED",
                "options": ["UNCONFINED", "CONFINED", "SEMI_CONFINED", "FRACTURED"],
            },
            {
                "name": "recharge_rate_mm_yr",
                "label": "Recharge",
                "unit": "mm/yr",
                "kind": "float",
                "default": 60.0,
