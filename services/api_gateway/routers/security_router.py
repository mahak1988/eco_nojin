...
async def security_status(request: Request):
    ...
    return {
        ...
        "layers": {
            ...
            "rate_limit": {
                "active": True,
                "mode": "in-memory-sliding-window",
                "upgrade": "redis/upstash for multi-worker",
            },
            ...
            "self_healing": {
                "active": True,
                "restarts": 0,
                "circuit_blocked_ips": len(circuit_breaker._blocked),
            },
            "honeypot": {
                "active": True,
                "traps": len(honeypot._blocked) + len(honeypot.hits),
