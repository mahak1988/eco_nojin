  ...
  fa: {
    ...
    phases: [
      ...
      },
      {
        ...
        title: 'اعتبار کربنی',
        desc: 'در فاز دوم، اعتبار معادل یک تن دی‌اکسیدکربن ترسیب‌شده تعریف می‌شود؛ اما فقط پس از راستی‌آزمایی مطابق ISO 14064-2 و تأیید نهاد اعتبارسنج مستقل (VVB) صادر و ثبت می‌شود.',
        status: 'در انتظار VVB',
      },
    ],
    chainTitle: 'زنجیرهٔ صدور اعتبار',
    chainLead: 'هیچ اعتباری از هوا بیرون نمی‌آید؛ مسیر هر اعتبار، پنج دروازهٔ سخت‌گیرانه دارد.',
    chain: [
      { title: 'متدولوژی', desc: 'ثبت عمومی روش‌شناسی مطابق اصول ICVCM و ISO 14064-2: baseline، additionality، permanence، leakage.' },
  ...
  en: {
    ...
    phases: [
      ...
      },
      {
        ...
        title: 'Carbon credit',
        desc: 'In phase two, the credit equals one tonne of sequestered CO2 — but it is issued and registered only after verification per ISO 14064-2 and confirmation by an independent validation body (VVB).',
        status: 'Awaiting VVB',
      },
    ],
    ...
    chain: [
      { title: 'Methodology', desc: 'Public registration of the methodology per ICVCM principles and ISO 14064-2: baseline, additionality, permanence, leakage.' },
