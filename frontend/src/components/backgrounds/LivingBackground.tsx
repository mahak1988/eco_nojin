...
export const LivingBackground: React.FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M0,160 C240,60 480,200 720,120 C960,40 1200,180 1440,100 L1440,220 L0,220 Z"
          fill={dark ? '#2a2119' : '#d9ead3'}
        />
        <path
          d="M0,190 C300,110 600,220 900,150 C1150,95 1300,200 1440,150 L1440,220 L0,220 Z"
          fill={dark ? '#1e1a16' : '#c4ddb8'}
          opacity="0.9"
        />
      </svg>
      ...
      {showBirds &&
        birds.map((b, i) => (
          ...
          >
            <path
              d="M5,25 Q25,5 50,22 Q75,5 95,25"
              fill="none"
              stroke="currentColor"
              strokeWidth="5"
              strokeLinecap="round"
      ...
      {showWater && (
        <div className="water">
          ...
          <svg className="wave w2" viewBox="0 0 2880 120" preserveAspectRatio="none">
            <path
              d="M0,70 C240,30 480,110 720,70 C960,30 1200,110 1440,70 C1680,30 1920,110 2160,70 C2400,30 2640,110 2880,70 L2880,120 L0,120 Z"
