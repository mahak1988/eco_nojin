    ...
    >
      <div style={{ maxWidth: 1400, margin: '0 auto' }}>
        ...
        >
          ...
          {/* Links */}
          <div>
            <h4 style={{ marginBottom: '1rem', color: 'var(--color-text-primary)' }}>دسترسی سریع</h4>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '1.5rem' }}>
            <a href="#" style={{ color: 'var(--color-text-tertiary)', fontSize: '0.875rem', textDecoration: 'none' }}>
              حریم خصوصی
            </a>
            <a href="#" style={{ color: 'var(--color-text-tertiary)', fontSize: '0.875rem', textDecoration: 'none' }}>
              قوانین
