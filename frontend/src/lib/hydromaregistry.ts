...
export const registry: RegistryEntry[] = [
  ...
  E({ id: 'mrv-iot', nameFa: 'MRV اینترنت اشیا', nameEn: 'IoT MRV', category: 'carbon', enginePath: 'engine/hydroma/mrv/iot_ingest.py', ref: 'MQTT / TTN v3', impl: 'engine', descFa: 'ورودی حسگرها با QA/QC و ردپای حسابرسی.', descEn: 'Sensor ingest with QA/QC screening and audit trail.' }),
  E({ id: 'mrv-citizen', nameFa: 'MRV شهروندی', nameEn: 'Citizen MRV', category: 'carbon', enginePath: 'engine/hydroma/mrv/schemas.py', ref: 'EM-01', impl: 'engine', descFa: 'سطح ۳: گزارش‌های میدانی آفلاین-اول کشاورزان.', descEn: 'Level 3: offline-first citizen field reports.' }),
  E({ id: 'mrv-qa', nameFa: 'QA/QC مشاهدات', nameEn: 'Observation QA/QC', category: 'carbon', enginePath: 'engine/hydroma/mrv/qa.py', ref: 'EM-01', impl: 'engine', descFa: 'بندهای فیزیکی پذیرش/مشکوک/رد با ردپای حسابرسی.', descEn: 'Plausibility bands (accepted/suspect/rejected) + audit trail.' }),
  E({ id: 'mrv-metrics', nameFa: 'سنجه‌های شفاف MRV', nameEn: 'Transparent MRV metrics', category: 'carbon', enginePath: 'engine/hydroma/mrv/metrics.py', ref: 'EM-01 §3', impl: 'engine', descFa: 'هر سنجه نشان منشأ دارد: real / simulated / no_data.', descEn: 'Every metric carries a provenance badge: real / simulated / no_data.' }),
