...
export default function HelpDocs() {
  const docs = [
    ['Setup &amp; login', '/docs/fa/47_phase6_user_actions.md'],
    ['Phase 8-B simulators', '/docs/fa/55_phase8b_simulators.md'],
    ['Security &amp; OGC', '/docs/fa/56_phase8c_security_ogc_ai.md'],
    ['Deploy + domain + LLM', '/docs/fa/57_deploy_domain_llm.md'],
  ];
  return (
    <div style={wrap}>
      ...
      <div style={section}>
        {docs.map(([n, h]) => (
          ...
          >
            <a href={h} style={{ color: '#0d9488', fontWeight: 700, fontSize: '0.85rem' }}>
              {n}
            </a>
          </div>
        ))}
      ...
      <div style={section}>
        ...
        <p style={p}>
          Use the AI advice card on the dashboard for natural-language recommendations backed by the
          knowledge base.
        </p>
      </div>
    </div>
