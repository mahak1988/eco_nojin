...
const modules = [
  {
    title: 'برنامه کشت',
    description: 'شبیه‌سازی رشد محصول و مقایسه سناریوهای کشت چندلایه',
    icon: <Sprout size={28} />,
    color: '#22c55e',
    to: '/simulator',
  },
  {
    title: 'مدیریت آب',
    description: 'بودجه آب، نفوذپذیری، رواناب و تغذیه آبخوان',
  ...
  {
    title: 'باد و فرسایش',
    description: 'تحلیل فرسایش بادی/آبی و طراحی بادشکن',
    icon: <Wind size={28} />,
    color: '#f59e0b',
    to: '/simulator',
  },
  {
    title: 'دامداری',
    description: 'شبیه‌ساز گاو، گوسفند، بز و طیور + اقتصاد گله',
    icon: <Beef size={28} />,
    color: '#b45309',
    to: '/simulator',
  },
  {
    title: 'کربن و اعتبار',
    description: 'پیش‌بینی ترشح کربن و صدور اعتبار کربن',
    icon: <Leaf size={28} />,
    color: '#10b981',
    to: '/simulator',
  },
  {
    title: 'نقشه و زمین',
    description: 'نمای سه‌بعدی مزرعه و تحلیل زمین',
    icon: <Map size={28} />,
    color: '#8b5cf6',
    to: '/simulator',
  },
  {
    title: 'بازارچه محلی',
    description: 'فروش مستقیم محصول بدون واسطه',
    icon: <Store size={28} />,
    color: '#eab308',
    to: '/simulator',
  },
  {
    title: 'گردشگری بوم‌گردی',
    description: 'تورهای روستایی و درآمد پایدار',
  ...
  {
    title: 'گزارش‌ها',
    description: 'تحلیل سودآوری و گزارش پایداری',
  ...
  },
  {
    ...
    description: 'NDVI و سلامت گیاه از فضا',
    ...
    <PublicLayout>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', maxWidth: 1000 }}>
          ...
          >
            <Button variant="primary" size="lg" icon={<Zap size={18} className="animate-pulse" />}>
              شروع رایگان
            </Button>
