...
export default function NotFoundPage() {
  ...
  return (
    <section className="flex min-h-[70vh] flex-col items-center justify-center gap-6 px-4 text-center">
      ...
      <span className="glass inline-flex h-16 w-16 items-center justify-center rounded-3xl text-[var(--color-leaf-300)]">
        <SearchX className="h-8 w-8" aria-hidden />
      </span>
      <h1 className="text-3xl font-extrabold text-[var(--color-night-100)] sm:text-4xl">{t.notFound.title}</h1>
      <p className="max-w-md text-sm leading-7 text-[var(--color-night-200)]/60">{t.notFound.lead}</p>
