...
export default function LandProfiles() {
  const dims = [
    ...
    'Chemical (pH, EC, OM, NPK)',
    'Fertility (CEC, base saturation)',
    'Water (field capacity, wilting point)',
  ];
  return (
    <div style={wrap}>
      ...
      <div style={section}>
        <h2 style={h2}>Profile dimensions</h2>
      ...
      <div style={section}>
        ...
        <p style={p}>
          SoilGrids (free) + lab samples + field pilots; every value is labelled with its source and
          confidence.
        </p>
      </div>
    </div>
