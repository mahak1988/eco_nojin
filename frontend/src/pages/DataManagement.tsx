...
export default function DataManagement() {
  const flows = [
    'CSV import for Kobo field samples',
    'Lab data upload (lab router)',
    'Supabase cloud sync (RLS-protected)',
    'OGC / WaterML exports',
  ];
  return (
    <div style={wrap}>
      ...
      <div style={section}>
        ...
        <p style={p}>
          Row-level security on Supabase: farmers see only their own rows; admins get full access;
