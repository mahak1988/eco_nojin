...
const items = [
  {
    icon: Lock,
    t: 'رمزنگاری سرتاسری',
    b: 'داده‌ها در انتقال (TLS) و در ذخیره‌سازی (AES-256) رمزنگاری می‌شوند.',
  },
  ...
  { icon: Database, t: 'حداقل داده', b: 'فقط داده‌های لازم برای ارائه سرویس جمع‌آوری می‌شود.' },
  {
    icon: ShieldCheck,
    t: 'حق فراموشی',
    b: 'هر زمان بخواهید، داده‌های شما به‌طور کامل حذف می‌شود.',
  },
];
...
export const PrivacyPage: React.FC = () => (
  <PublicLayout>
    <section style={{ maxWidth: 960, margin: '0 auto', padding: '7rem 2rem 5rem' }}>
      <h1
        style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '1rem', textAlign: 'center' }}
      >
        حریم خصوصی
      </h1>
      <p
        style={{ textAlign: 'center', color: 'var(--color-text-secondary)', marginBottom: '3rem' }}
      >
        حریم شما، خط قرمز ماست.
      </p>
      <div
        style={{
          display: 'grid',
