...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const navItems = [
    ...
    },
    {
      path: '/admin/crypto',
      label: t('nav.crypto'),
      icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V7m0 10v1m9-9a9 9 0 11-18 0 9 9 0 0118 0z',
    },
    {
      ...
      <main style={{ flex: 1, overflow: 'auto', minWidth: 0 }}>
        ...
        <header className="admin-header">
          ...
          <div className="header-title-section">
            <h1 className="header-title">{currentNav?.label || t('nav.overview')}</h1>
          ...
          <div className="header-actions">
            ...
            <button
              ...
              title={language === 'fa' ? 'Switch to English' : 'طھط؛غŒغŒط± ط¨ظ‡ ظپط§ط±ط³غŒ'}
            >
