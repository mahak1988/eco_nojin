      ...
      <div dir={direction} style={{ background: colors.bg, minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '80px 20px', textAlign: 'center' }}>
          ...
          <p style={{ color: colors.textMuted }}>
            {currentLang === 'fa' ? 'برای دسترسی به کیف پول ECO وارد شوید' : 'Login to access your ECO wallet'}
          </p>
        </div>
        <Footer />
      </div>
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '32px 20px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div>
              <h1 style={{ fontSize: '2rem', fontWeight: '800', margin: 0 }}>
                {currentLang === 'fa' ? 'کیف پول ECO' : 'ECO Wallet'}
              </h1>
              <p style={{ margin: '4px 0 0', opacity: 0.95 }}>
                {currentLang === 'fa' ? 'اقتصاد پایدار برای کشاورزان' : 'Sustainable economy for farmers'}
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div>
            <div style={{ fontSize: '0.85rem', color: colors.textMuted, marginBottom: '8px' }}>
              {currentLang === 'fa' ? 'موجودی' : 'Current Balance'}
            </div>
          ...
          <div>
            <div style={{ fontSize: '0.85rem', color: colors.textMuted, marginBottom: '8px' }}>
              {currentLang === 'fa' ? 'کل کسب شده' : 'Total Earned'}
            </div>
          ...
          <div>
            <div style={{ fontSize: '0.85rem', color: colors.textMuted, marginBottom: '8px' }}>
              {currentLang === 'fa' ? 'کل خرج شده' : 'Total Redeemed'}
            </div>
          ...
          <div>
            <div style={{ fontSize: '0.85rem', color: colors.textMuted, marginBottom: '8px' }}>
              {currentLang === 'fa' ? 'تراکنش‌ها' : 'Transactions'}
            </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '24px' }}>
            ...
            >
              <h3 style={{ color: colors.text, marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                {currentLang === 'fa' ? 'جریان ماهانه' : 'Monthly Flow'}
              </h3>
            ...
            >
              <h3 style={{ color: colors.text, marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                {currentLang === 'fa' ? 'کسب بر اساس دسته' : 'Earning by Category'}
              </h3>
        ...
        >
          <h3 style={{ color: colors.text, marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <TrendingUp size={20} color={colors.success} />
            {currentLang === 'fa' ? 'کسب ECO' : 'Earn ECO'}
          </h3>
        ...
        >
          <h3 style={{ color: colors.text, marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            {currentLang === 'fa' ? 'استفاده از ECO' : 'Redeem ECO'}
          </h3>
            ...
            {redemptionOptions.map((opt) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {canAfford ? (currentLang === 'fa' ? 'استفاده' : 'Redeem') : (currentLang === 'fa' ? 'موجودی کافی نیست' : 'Insufficient balance')}
                  </button>
                </motion.div>
              );
            })}
