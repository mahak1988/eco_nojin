            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                <h1 style={{ fontSize: '2rem', fontWeight: '800', margin: 0 }}>
                  {t('an_advanced_analytics')}
                </h1>
                <p style={{ margin: '4px 0 0', opacity: 0.95 }}>
                  {t('an_unified_dashboard')}
                </p>
              </div>
            </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '16px', marginBottom: '32px' }}>
              {[
                { icon: TreePine, label: t('an_farms'), value: overview?.farms_count || 0, color: '#10b981' },
                { icon: Leaf, label: t('an_soil_tests'), value: overview?.soil_analyses_count || 0, color: '#f59e0b' },
                { icon: Satellite, label: t('an_satellite'), value: overview?.satellite_analyses_count || 0, color: '#3b82f6' },
                { icon: TrendingUp, label: t('an_scenarios'), value: overview?.scenario_runs_count || 0, color: '#8b5cf6' },
                { icon: Award, label: t('an_carbon'), value: overview?.carbon_projects_count || 0, color: '#ec4899' },
              ].map((stat, i) => {
