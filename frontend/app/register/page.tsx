...
const LANGUAGES = [
  { value: 'fa', label: 'ظپط§ط±ط³غŒ', flag: 'ًں‡®ًں‡·' },
  { value: 'en', label: 'English', flag: 'ًں‡¬ًں‡§' },
  { value: 'ar', label: 'ط§ظ„ط¹ط±ط¨ظٹط©', flag: 'ًں‡¸ًں‡¦' },
  { value: 'tr', label: 'Tأ¼rkأ§e', flag: 'ًں‡¹ًں‡·' },
];
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
              <div>
                ...
                <input type="text" value={formData.full_name}
                  ...
                  placeholder="Your name" style={inputStyle(!!errors.name && !!formData.full_name)} />
              ...
              <div>
                ...
                <input type="email" value={formData.email}
                  ...
                  placeholder="you@example.com" style={inputStyle(!!errors.email && !!formData.email)} />
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '20px' }}>
              <div>
                ...
                <input type="password" value={formData.password}
                  ...
                  placeholder="Min 6 characters" style={inputStyle(!!errors.password && !!formData.password)} />
                {formData.password && (
              ...
              <div>
                ...
                <input type="password" value={formData.confirmPassword}
                  ...
                  placeholder="Repeat password" style={inputStyle(!!errors.confirm && !!formData.confirmPassword)} />
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '12px' }}>
              <div>
                ...
                <input type="tel" value={formData.phone}
                  ...
                  placeholder="+98..." style={inputStyle(null)} />
              </div>
              <div>
