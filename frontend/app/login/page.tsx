    ...
    <div dir="ltr" style={{ 
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
          {[
            { email: 'farmer@test.com', pw: 'farmer123', label: '🌾 Farmer' },
            { email: 'researcher@test.com', pw: 'research123', label: '🔬 Researcher' },
            { email: 'org@test.com', pw: 'org123', label: '🏢 Organization' },
            { email: 'admin@test.com', pw: 'admin123', label: '👤 Admin' },
          ].map((acc) => (
...
// Phase 0: useSearchParams requires a Suspense boundary during static prerendering (Next.js 16).
