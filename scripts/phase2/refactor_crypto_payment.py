...
def main():
    logger.info("\n" + "=" * 70)
    logger.info("  🚀 Phase 2 - Refactor CryptoPaymentWidget")
    logger.info("=" * 70 + "\n")
    ...
    # ── گام ۲: ساختار ─────────────────────────────────────
    logger.info("📁 گام ۲: ایجاد ساختار features/crypto-payment/...")
    ...
    logger.info("🔄 گام ۹: جایگزینی CryptoPaymentWidget.tsx...")
    ...
    logger.info("🔍 گام ۱۰: بررسی @tanstack/react-query...")
    ...
    logger.info("\033[1m\033[92m  🎉 CryptoPaymentWidget با موفقیت refactor شد! 🎉\033[0m")
    logger.info("\033[1m\033[92m" + "=" * 70 + "\033[0m\n")

    logger.info("  📊 آمار:")
    logger.info("    ✓ 323 → ~90 lines (72% reduction)")
    logger.info("    ✓ Build موفق")
    logger.info("    ✓ معماری feature-based")
    logger.info("    ✓ React Query integration")
    logger.error("    ✓ Error Boundary")
    logger.info("    ✓ Type safety (no any)")
    logger.info()

    logger.info("  🏗️ ساختار جدید:")
    logger.info("    features/crypto-payment/")
    logger.info("    ├── types/        (1 file)")
    logger.info("    ├── constants/    (2 files)")
    logger.info("    ├── utils/        (2 files)")
    ...
    logger.info("    • انتخاب فایل بعدی از ۶ فایل باقی‌مانده")
    logger.info("    • ادامه با EcoWalletDashboard.tsx (HIGH)")
    logger.info()
