...
این ماژول سازگاری کامل با نسخه قبلی دارد و قابلیت‌های جدید اضافه می‌کند.
"""
...
# ============================================================
# لایه ۱: پایگاه داده ۳۰ گونه کارشناسی‌شده (بدون تغییر)
# ============================================================
...
CROP_DATABASE: dict[str, CropProfile] = {
    ...
    # در فایل واقعی، تمام ۳۰ گونه از فایل قبلی کپی شوند.
}
...
class CropDatabaseService:
    ...
    def _profile_to_dict(self, p: CropProfile) -> Dict[str, Any]:
        ...
        return {
            ...
            "drought_tolerance_1_5": self._tolerance_to_scale(p.water.drought_tolerance),
            "water_need_1_5": self._water_to_scale(p.water),
            "frost_tolerance_1_5": 5 if p.temperature.frost_tolerance else 1,
            "growth_days_min": int(p.growing_days * 0.8),
