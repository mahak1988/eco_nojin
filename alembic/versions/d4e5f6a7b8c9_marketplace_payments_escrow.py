...
down_revision: str | Sequence[str] | None = "b2f8a4c61e90"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_marketplace_escrow_entries_seller_id", "marketplace_escrow_entries", ["seller_id"]
    )
    op.create_index(
        "ix_marketplace_escrow_entries_marketplace_id",
        "marketplace_escrow_entries",
        ["marketplace_id"],
    )
