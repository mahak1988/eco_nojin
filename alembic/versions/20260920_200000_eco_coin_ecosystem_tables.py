...
def upgrade() -> None:
    ...
    op.add_column(
        "ecowallet", sa.Column("kyc_status", sa.String(32), nullable=False, default="pending")
    )
    op.add_column(
        "ecowallet", sa.Column("self_custody_enabled", sa.Boolean(), nullable=False, default=False)
    )
    op.add_column("ecowallet", sa.Column("external_wallet_address", sa.String(130), nullable=True))
    op.add_column(
        "ecowallet", sa.Column("transfer_enabled_at", sa.DateTime(timezone=True), nullable=True)
    )
