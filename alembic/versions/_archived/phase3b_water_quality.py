...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_water_quality_land_date", "water_quality", ["land_profile_id", "sample_date"]
    )
    ...
    op.create_index(
        "ix_stream_gauge_land_date", "stream_gauge_data", ["land_profile_id", "measurement_date"]
    )
