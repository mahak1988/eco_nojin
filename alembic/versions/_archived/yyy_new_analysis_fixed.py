...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_topography_analysis_results_id"),
        "topography_analysis_results",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_topography_analysis_results_site_id"),
        "topography_analysis_results",
        ["site_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_runoff_calculation_results_id"), "runoff_calculation_results", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_runoff_calculation_results_site_id"),
        "runoff_calculation_results",
        ["site_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_groundwater_model_results_id"), "groundwater_model_results", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_groundwater_model_results_site_id"),
        "groundwater_model_results",
        ["site_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_crop_water_req_results_id"), "crop_water_req_results", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_crop_water_req_results_site_id"),
        "crop_water_req_results",
        ["site_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_structure_design_results_design_id"),
        "structure_design_results",
        ["design_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_structure_design_results_id"), "structure_design_results", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_irrigation_design_results_design_id"),
        "irrigation_design_results",
        ["design_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_irrigation_design_results_id"), "irrigation_design_results", ["id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_calibration_results_model_name"),
        "calibration_results",
        ["model_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_calibration_results_site_id"), "calibration_results", ["site_id"], unique=False
    )
