...
DRAINAGE_STANDARDS: list[DrainageStandard] = [
    DrainageStandard(
        ...
        density_min_km_km2=0,
        density_max_km_km2=2,
    ...
    DrainageStandard(
        code="low",
        name="Low Density",
        density_min_km_km2=2,
        density_max_km_km2=5,
    ...
    DrainageStandard(
        ...
        density_min_km_km2=5,
        density_max_km_km2=15,
    ...
    DrainageStandard(
        code="high",
        name="High Density",
        density_min_km_km2=15,
        density_max_km_km2=30,
    ...
    DrainageStandard(
        ...
        density_min_km_km2=30,
        density_max_km_km2=100,
...
def get_city(name: str) -> City:
    ...
    for c in CITIES:
        if c.name.lower() == name_lower or (c.name_fa and c.name_fa == name):
            return c
...
def list_cities(country_code: str = None, region_code: str = None) -> list[City]:
    ...
    result = CITIES
    if country_code:
        result = [c for c in result if c.country_code.upper() == country_code.upper()]
    if region_code:
