...
/// Hargreaves-Samani ET0 calculation for arrays of inputs (parallel).
...
/// Full FAO-56 Penman-Monteith reference evapotranspiration for arrays (parallel).
...
/// Extraterrestrial radiation calculation for arrays of inputs (parallel).
