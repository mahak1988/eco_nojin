"""
Unit tests for plants module.
"""
import pytest
from engine.hydroma.plants import PlantsService


class TestPlantsService:
    """Tests for PlantsService."""
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.plants.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.plants.utils import normalize_percentage
