"""
Unit tests for hydrology module.
"""
import pytest
from engine.hydroma.hydrology import HydrologyService


class TestHydrologyService:
    """Tests for HydrologyService."""
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.hydrology.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.hydrology.utils import normalize_percentage
