"""
Unit tests for groundwater module.
"""
import pytest
from engine.hydroma.groundwater import GroundwaterService


class TestGroundwaterService:
    """Tests for GroundwaterService."""
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.groundwater.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.groundwater.utils import normalize_percentage
