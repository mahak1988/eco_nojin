"""
Unit tests for crop module.
"""
import pytest
from engine.hydroma.crop import CropService
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.crop.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.crop.utils import normalize_percentage
