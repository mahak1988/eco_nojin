...
"""
import pytest
from engine.hydroma.risk import RiskService
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.risk.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.risk.utils import normalize_percentage
