...
class SoilDegradationModel:
    ...
    # ------------------------------------------------------------------- H10
    def h10_root_depth_decay(
        self,
        initial_root_depth_cm: float,
    ...
    # ------------------------------------------------------------------- H11
    def h11_salinity_trend(
        self,
        ec_initial_ds_m: float,
        ...
        """
        ec_projected = ec_initial_ds_m + trend_rate_ds_m_per_yr * years + irrigation_quality_penalty
    ...
    # ------------------------------------------------------------------- H13
    def h13_soil_fertility_index(
        self,
        soc_pct: float,
        n_pct: float,
        p_available_ppm: float,
    ...
    def h14_subsidence_risk(
        ...
        subsidence_rate = (
            (groundwater_extraction_mm_yr / 1000.0) * sensitivity * (50.0 / aquifer_thickness_m)
        )
    ...
    # ------------------------------------------------------------------ H11+
    def h11_salinity_sodicity_trend(
        self,
        ec_initial: float,
        sar_initial: float,
    ...
    def generate_degradation_report(
        ...
        report = {
            ...
            "h13_fertility": self.h13_soil_fertility_index(soc_pct, 0.15, 25.0, 200.0, 7.0, 0.5),
