"""
Unit tests for mrv module.
"""
import pytest
from engine.hydroma.mrv import MRVService


class TestMRVService:
    """Tests for MRVService."""
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.mrv.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.mrv.utils import normalize_percentage
