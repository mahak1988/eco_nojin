"""
Unit tests for geospatial module.
"""
import pytest
from engine.hydroma.geospatial import GeospatialService


class TestGeospatialService:
    """Tests for GeospatialService."""
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.geospatial.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.geospatial.utils import normalize_percentage
