...
"""
import pytest
from engine.hydroma.web_search import WebSearchService
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.web_search.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.web_search.utils import normalize_percentage
