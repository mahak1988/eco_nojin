...
class NojinStrainRepository:
    ...
    def get_by_id(self, strain_id: int) -> Optional[NojinStrain]:
        """Get strain by ID."""
        return self.session.query(NojinStrain).filter(NojinStrain.id == strain_id).first()
    
    def get_by_code(self, strain_code: str) -> Optional[NojinStrain]:
        """Get strain by code."""
    ...
    def update(self, strain_id: int, **kwargs) -> Optional[NojinStrain]:
        """Update a strain."""
...
class NojinFormulationRepository:
    ...
    def get_by_id(self, formulation_id: int) -> Optional[NojinFormulation]:
        """Get formulation by ID."""
        return self.session.query(NojinFormulation).filter(
            NojinFormulation.id == formulation_id
        ).first()
    
    def get_by_code(self, formulation_code: str) -> Optional[NojinFormulation]:
    ...
    def update(self, formulation_id: int, **kwargs) -> Optional[NojinFormulation]:
...
class NojinApplicationPlanRepository:
    ...
    def get_by_id(self, plan_id: int) -> Optional[NojinApplicationPlan]:
        """Get plan by ID."""
    ...
    def update(self, plan_id: int, **kwargs) -> Optional[NojinApplicationPlan]:
        """Update a plan."""
...
class NojinFieldTrialRepository:
    ...
    def get_by_id(self, trial_id: int) -> Optional[NojinFieldTrial]:
        """Get trial by ID."""
    ...
    def update(self, trial_id: int, **kwargs) -> Optional[NojinFieldTrial]:
        """Update a trial."""
...
class NojinCalibrationRecordRepository:
    ...
    def get_by_id(self, record_id: int) -> Optional[NojinCalibrationRecord]:
        """Get record by ID."""
        return self.session.query(NojinCalibrationRecord).filter(
            NojinCalibrationRecord.id == record_id
        ).first()
    
    def get_latest_for_formulation(self, formulation_id: int) -> Optional[NojinCalibrationRecord]:
...
class NojinMaterialRepository:
    ...
    def get_by_id(self, material_id: int) -> Optional[NojinMaterial]:
        """Get material by ID."""
        return self.session.get(NojinMaterial, material_id)
    
    def get_by_code(self, material_code: str) -> Optional[NojinMaterial]:
    ...
    def update(self, material_id: int, **kwargs) -> Optional[NojinMaterial]:
        """Update a material."""
...
class NojinSoilTypeRepository:
    ...
    def get_by_id(self, soil_id: int) -> Optional[NojinSoilType]:
        """Get soil type by ID."""
        return self.session.get(NojinSoilType, soil_id)
    
    def get_by_code(self, soil_code: str) -> Optional[NojinSoilType]:
...
class NojinFormulationRecipeRepository:
    ...
    def get_by_id(self, recipe_id: int) -> Optional[NojinFormulationRecipe]:
        """Get recipe by ID."""
        return self.session.get(NojinFormulationRecipe, recipe_id)
    
    def get_by_code(self, recipe_code: str) -> Optional[NojinFormulationRecipe]:
    ...
    def get_for_soil_code(self, soil_code: str) -> Optional[NojinFormulationRecipe]:
