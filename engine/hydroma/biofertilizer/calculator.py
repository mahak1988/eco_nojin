...
class SoilCondition:
    ...
    moisture_pct: float
    texture: str = "loam"
    microbiome_diversity_index: float | None = None  # Shannon diversity
...
class NojinInput:
    ...
    strains: list[StrainProfile] | None = None
    season: str | None = None  # "spring", "summer", "fall", "winter"
    irrigation_available: bool = False
    water_stress_index: float | None = None  # From Phase 3 integration
...
class NojinResult:
    ...
    carbon_sequestration_potential: float | None = None  # For Phase 8
...
class NojinCalculator:
    ...
    def _assess_season(self, season: str | None) -> str:
