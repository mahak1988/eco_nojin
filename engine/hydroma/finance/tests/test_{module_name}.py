...
"""
import pytest
from engine.hydroma.finance import FinanceService
...
class TestUtils:
    ...
    def test_validate_range_valid(self):
        ...
        from engine.hydroma.finance.utils import validate_range
    ...
    def test_normalize_percentage_valid(self):
        ...
        from engine.hydroma.finance.utils import normalize_percentage
