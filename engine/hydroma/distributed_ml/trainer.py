...
class DistributedTrainer:
    ...
    def setup_distributed(self) -> None:
        ...
        if self.config.world_size > 1:
            ...
            logger.info(f"Initialized distributed training: rank={self.config.rank}, world_size={self.config.world_size}")
    ...
    def save_checkpoint(
        ...
        checkpoint = {
            "epoch": epoch,
            "step": step,
            "model_state_dict": self._model.module.state_dict() if hasattr(self._model, "module") else self._model.state_dict(),
...
class ExperimentTracker:
    ...
    def start_run(self, run_name: Optional[str] = None, tags: Optional[Dict] = None) -> Any:
