...
def _auth_headers(
    email: str = "blockchain-test@example.com", password: str = "TestPass123"
) -> dict:
    resp = client.post(
...
class TestBlockchainAPIEndpoints:
    ...
    @pytest.mark.skip(reason="Endpoint /api/v1/blockchain/supply-chain/products not implemented")
