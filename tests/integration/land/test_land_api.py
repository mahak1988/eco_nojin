...
class TestLandAPI:
    ...
    def test_list_profiles(self, client):
        ...
        client.post(
            "/api/v1/land/profiles",
            json={"name": "پروفایل 1", "location_lat": 0, "location_lon": 0},
        )
        client.post(
            "/api/v1/land/profiles",
            json={"name": "پروفایل 2", "location_lat": 0, "location_lon": 0},
        )
    ...
    def test_get_profile(self, client):
        ...
        create_response = client.post(
            "/api/v1/land/profiles",
            json={"name": "تست", "location_lat": 10.0, "location_lon": 20.0},
        )
    ...
    def test_delete_profile(self, client):
        ...
        # Create profile
        create_response = client.post(
            "/api/v1/land/profiles", json={"name": "حذف", "location_lat": 0, "location_lon": 0}
        )
        profile_id = create_response.json()["id"]
    ...
    def test_analyze_terrain(self, client):
        ...
        # Create profile
        create_response = client.post(
            "/api/v1/land/profiles", json={"name": "تحلیل", "location_lat": 0, "location_lon": 0}
        )
        profile_id = create_response.json()["id"]
    ...
    def test_analyze_drainage(self, client):
        ...
        # Create profile
        create_response = client.post(
            "/api/v1/land/profiles", json={"name": "زهکشی", "location_lat": 0, "location_lon": 0}
        )
        profile_id = create_response.json()["id"]
    ...
    def test_assess_capability(self, client):
        ...
        # Create profile
        create_response = client.post(
            "/api/v1/land/profiles", json={"name": "قابلیت", "location_lat": 0, "location_lon": 0}
        )
        profile_id = create_response.json()["id"]
    ...
    def test_full_workflow(self, client):
        ...
        response = client.post(
            f"/api/v1/land/profiles/{profile_id}/capability-assessment",
            json={"slope_degrees": 8.0, "soil_depth_m": 1.2, "erosion_risk": "moderate"},
        )
        assert response.status_code == 200
